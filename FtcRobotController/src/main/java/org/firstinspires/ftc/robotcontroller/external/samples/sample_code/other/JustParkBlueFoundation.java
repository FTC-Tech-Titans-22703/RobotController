 ...
 * is explained below.
 */
@Autonomous(name = "JustParkBlueFoundation", group = "")
//@Disabled
public class JustParkBlueFoundation extends LinearOpMode {
	private DcMotor rf;
	private DcMotor lb;
	private DcMotor rb;
	private DcMotor lf;
   ...
   // private DcMotor clawArm;
	...
	strafeRight(0.7, 70);//close to the wall:70, far from the wall: 1000
	   strafeBackward(0.4, 1000);  }
