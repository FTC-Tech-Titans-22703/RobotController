 ...
 * is explained below.
 */
@Autonomous(name = "NewSkyStoneRed", group = "")
//@Disabled
public class NewSkyStoneBlue extends LinearOpMode {
...
protected boolean firstskystone(float p) {
 ...
 strafeRight(0.2, 270);
  ...
  strafeForward(0, 100);
   ...
   rotateCCW(0.5, 600);
   strafeRight(0,100);
  strafeRight(0.4, 1200);
  strafeRight(0,200);
  strafeLeft(0.4, 1500);
ServoArmClamp(-0.4, 300);
 //rotateCCW(0.5, 600);
 strafeBackward(0,100);
  strafeBackward(0.2, 600);
  ls.setPower(1);
  rs.setPower(1);
  sleep(300);
  strafeForward(0,250);
