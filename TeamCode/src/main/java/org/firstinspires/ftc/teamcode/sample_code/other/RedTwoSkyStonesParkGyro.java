 ...
 * is explained below.
 */
@Autonomous(name = "RedTwoSkyStonesParkGyro", group = "")
//@Disabled
public class RedTwoSkyStonesParkGyro extends LinearOpMode {
...
/**
  ...
  private boolean IMU_Calibrated() {
	...
	private void leftservoArmDown(double power, double msTime) {
	  ElapsedTime runtime = new ElapsedTime();
	  runtime.reset();

	  while (runtime.milliseconds() < msTime) {
		LeftServoArm.setPower(power);
	  }
	}

	private void leftservoArmUp(double power, double msTime) {
	  ElapsedTime runtime = new ElapsedTime();
	  runtime.reset();
	 ...
	 private void leftServoArmClamp(double power, double msTime) {
	  ElapsedTime runtime = new ElapsedTime();
	  runtime.reset();

	  while (runtime.milliseconds() < msTime) {
		leftServoArmClamp.setPower(power);
	  }
	}
...
protected void runSample() {
  ...
  // Distance sensor
	...
	while (d == false) {
	double sensor_range;
			sensor_range = sensorRange2.getDistance(DistanceUnit.CM);
	d= getCloser(sensor_range);
	  ...
	  if (bCurrState != bPrevState) {
		...
		if (bCurrState) {
		  if (colorSensor2 instanceof SwitchableLight) {
			SwitchableLight light = (SwitchableLight)colorSensor2;
...
protected boolean getCloser(double sensor_range){
  //  ServoArmClamp.setPower(-0.4);
	//		servoArm.setPower(0.9);
			if(sensor_range > 11) {
				rf.setPower(0.317);
				lf.setPower(-0.31);
				rb.setPower(-0.29);
...
//ServoArmClamp.setPower(0.5);
  //		  servoArm.setPower(0.18);
...
strafeForward(0.2, 50);
  strafeLeft(0.2, 100);
  leftservoArmDown(-1, 1400);
  strafeLeft(0.2, 300);
  leftServoArmClamp(1, 500);
  leftservoArmUp(0.6,500);
  strafeRight(0.3, 340);

  DriveRoboStraight(0.8, 1400); 
  leftservoArmDown(-0.9, 500);
  leftServoArmClamp(0.6, 300);
  leftservoArmUp(-0.6, 500);
	
   leftservoArmUp(0.7,500);
   //strafeLeft(0.3, 700);
//leftServoArmClamp(-0.9, 300);
 /*rf.setPower(0.2);
   rb.setPower(0.2);
   lf.setPower(-0.2);
   lb.setPower(-0.2);
   sleep(15);*/
  DriveRoboStraight(-0.8, 1860); 
   rotateCCW(-0.2, 30);
   strafeLeft(0.2,400);
   rotateCCW(-0.2, 100);
   //strafeLeft(0.2, 400);
...
//ServoArmClamp.setPower(0.18);
	 //strafeLeft(0.2, 100);
	 //strafeRight(0.3, 70);
	 //rotateCCW(-0.2, 70);
	 rotateCCW(0.2, 30);
	 //rotateCCW(-0.2, 10);
	 // leftServoArmClamp(-0.3, 300);
	  //strafeLeft(0.2, 150);
   //strafeBackward(0.1, 250);
   DriveRoboStraight(-0.1, 250); 
	 //strafeRight(0.2, 200);
		  leftServoArmClamp(0.3, 1200);
		  strafeLeft(0.2, 100);
  leftservoArmDown(-0.8, 500);
	 leftServoArmClamp(1, 1200);
   //strafeLeft(0, 500);
 //strafeLeft(0.3, 600);
   //leftServoArmClamp(-1, 1200);
   leftservoArmUp(0.7,500);
  ...
  rotateCCW(0.2, 40);
   ...
   //strafeForward(0, 300);
   DriveRoboStraight(0.8, 1900); 
//   DriveRoboStraight(0, 150); 
  
	leftservoArmDown(-0.8, 500);
	  leftServoArmClamp(-0.3, 300);
   leftservoArmUp(0.7,500);
	  leftServoArmClamp(-0.4, 300);
   //strafeBackward(0.6, 950);
   DriveRoboStraight(-0.6, 800); 
